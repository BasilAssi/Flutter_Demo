...
class TestProductWidget extends StatefulWidget {
  const TestProductWidget({Key? key}) : super(key: key);

  @override
  _TestProductWidgetState createState() => _TestProductWidgetState();
}
            ...
            children: [
              Padding(
                ...
                child: TextFormField(
                  ...
                  maxLines: null,
                  validator: _model.searchProdcutControllerValidator
                      .asValidator(context),
                ),
              ),
              Row(
                ...
                child: Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future: ProductAPICall.call(
                      searchValue: _model.searchProdcutController.text,
                    ),
                    builder: (context, snapshot) {
                      ...
                      return Builder(
                        builder: (context) {
                          final productItem = ProductAPICall.productData(
